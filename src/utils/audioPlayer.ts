...
export const playAudioFromText = async (
  ...
  try {
    ...
    stopRobotSpeakingAnimation(setRobotPose, idlePose);
...
const stopRobotSpeakingAnimation = (
  setRobotPose?: (pose: string) => void,
  idlePose?: string
): void => {
  console.log('🤖 Stopping robot speaking animation');
